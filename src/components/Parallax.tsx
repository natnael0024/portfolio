...
const Parallax = ({type}) => {
  ...
  return (
    <div ref={ref} className=' overflow-hidden relative h-full flex items-center justify-center'>
        ...
        <motion.div style={{y:bgY}}  variants={iconVariants2} transition={{duration:3, repeat:Infinity, repeatType:'mirror', type:'spring'}} initial='initial' whileInView={'animate'}  
        ...
        <motion.div  
        // animate={{ rotateZ:10 }}  transition={{ type: 'spring', restDelta: 0.5, repeatType:'reverse', repeat:Infinity, duration:3 }}
        ...
        {/* <div className="container">
          ...
          <motion.div
            ...
            transition={{duration: 4, yoyo: Infinity, ease: "easeInOut", repeat:Infinity}}
            >
              <Image
            src={trophy}
            fill
